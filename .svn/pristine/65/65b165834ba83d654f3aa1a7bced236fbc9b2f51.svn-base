...
import com.tzg.tool.kit.Exceptions;
 ...
 * 
 * 此外根据xml schma生产java映射类，jdk中提供了xjc.exe工具：
 *  xjc -p com.tzg.xml.model schema -d src/main/java
 * 也可以定义dtd和xjs文件，执行java com.tzg.xml.model data.dtd data.xjs 
 *  
 */
public class JaxbMapper {
    ...
    /**
     * xml to java object
     * xml string to java object method is :fromXml(xml) 
     */
